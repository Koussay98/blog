                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            ...
                                                            <img class="media-object" src="http://localhost/blog-test/storage/app/public/profile/{{ $comment->user->image }}" width="64" height="64">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="media">
                                                    <div class="media-right">
                                                        <a target="_blank" href="{{ route('post.details',$comment->post->slug) }}">
                                                            ...
                                                            <img class="media-object" src="http://localhost/blog-test/storage/app/public/post/{{ $comment->post->image }}"width="64" height="64">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <a target="_blank" href="{{ route('post.details',$comment->post->slug) }}">
