...
@push('css')
    ...
    <style>
        .header-bg{
            ...
            background-image:  url("http://localhost/blog-test/storage/app/public/post/{{ $post->image }}");
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    ...
                                    <a class="avatar" href="#">
                                    <img src="http://localhost/blog-test/storage/app/public/profile/{{ $post->user->image }}" alt="Profile Image"></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <img src="http://localhost/blog-test/storage/app/public/post/{{ $randompost->image }}" alt="{{ $randompost->title }}"></div>

                                <a class="avatar" href="#">
                               
                                <img src= "http://localhost/blog-test/storage/app/public/profile/{{ $randompost->user->image }}" alt="Profile Image"></a>
                                ...
                                <div class="comment">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="left-area">
                                            ...
                                            <a class="avatar" href="#"><img src=  "http://localhost/blog-test/storage/app/public/profile/{{ $comment->user->image }}" alt="Profile Image"></a>
                                        </div>
